  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div className="card-dark p-5 md:p-6 max-w-md w-full mx-auto border border-red-500/30">
        ...
        <p className="text-[#5f471d] dark:text-[#A7C4B8] mb-6">
          {showDeleteModal === 'all'
        ...
        <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
          ...
          <button
            ...
            disabled={deleteLoading}
            className="px-4 py-2 rounded-lg bg-red-600 hover:bg-red-700 text-[#0f1419] dark:text-[#F0FDF4] font-medium transition-colors disabled:opacity-50"
          >
