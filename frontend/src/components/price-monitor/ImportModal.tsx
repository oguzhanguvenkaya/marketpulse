...
export default function ImportModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="card-dark border border-accent-primary/12 p-5 md:p-6 w-full max-w-2xl mx-auto my-auto">
        ...
        <p className="text-sm text-text-muted mb-3">Paste JSON in the following format:</p>
        <pre className="bg-dark-900 p-3 rounded-lg text-xs text-text-body mb-4 overflow-x-auto border border-accent-primary/8">
          {getImportExample()}
        </pre>
        <textarea
          value={importJson}
