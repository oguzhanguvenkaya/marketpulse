    ...
    <div className="space-y-5 md:space-y-6 animate-fade-in">
      ...
      {loading ? (
        ...
        <div className="card-dark p-10 md:p-12 text-center">
          ...
          <p className="text-sm text-neutral-500 dark:text-text-muted mt-1">Start a search from Dashboard to collect data</p>
        </div>
      ) : (
                    ...
                    <Link to={`/products/${product.id}`} className="flex items-center gap-3 group">
                      {product.image_url ? (
                        ...
                        <div className="w-12 h-12 rounded-lg bg-surface-hover flex items-center justify-center">
                          <svg className="w-5 h-5 text-neutral-500 dark:text-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="min-w-0">
                        ...
                        {product.seller_name && (
                          <div className="text-xs text-neutral-500 dark:text-text-muted">{product.seller_name}</div>
                        )}
                      </div>
                    </Link>
                  </td>
