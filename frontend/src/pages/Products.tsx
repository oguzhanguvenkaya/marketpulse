    ...
    <div className="space-y-5 md:space-y-6 animate-fade-in">
      ...
      {loading ? (
        ...
        <div className="card-dark p-10 md:p-12 text-center">
          ...
          <p className="text-neutral-400">No products found yet</p>
                ...
                <tr key={product.id}>
                  <td>
                    <Link to={`/products/${product.id}`} className="flex items-center gap-3 group">
                      {product.image_url ? (
                        <img src={product.image_url} alt="" className="w-12 h-12 object-cover rounded-lg border border-white/10" />
                      ) : (
                  ...
                  <td>
                    {product.latest_rating ? (
                      <span className="flex items-center gap-1.5">
                        ...
                        <span className="text-neutral-200">{product.latest_rating.toFixed(1)}</span>
                      </span>
                    ) : (
